        ...
        <form method="GET" action="{{ route('courses.index') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2">
                    <label for="search" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">Cari
                        Pelatihan</label>
                    <div class="relative">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-slate-100">
                <div class="flex items-center gap-2">
                    ...
                    <select name="sort"
                        ...
                        <option value="popular" {{ request('sort') === 'popular' ? 'selected' : '' }}>Paling Banyak Peserta
                        </option>
