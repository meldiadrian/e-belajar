...
@section('content')
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        <div class="border-b border-slate-100 pb-4">
            <h2 class="text-xl font-black text-slate-900">Form Pembuatan Kursus Baru</h2>
        ...
        <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                <label for="title" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">Judul Kursus
                    *</label>
            ...
            <div>
                <label for="category_id"
                    class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">Kategori Program
                    *</label>
            ...
            <div class="pt-6 border-t border-slate-100 flex items-center justify-between">
                ...
                <button type="submit"
                    ...
                    Simpan & Lanjutkan ke Course Builder &rarr;
                </button>
            </div>
        </form>
    </div>
